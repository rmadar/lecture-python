...
**[1. Python basics.](lectures/1-PythonIntroduction.ipynb)** This first section is dedicated to basic object type and operation in python. Fonctions will also be described but object oriented programming will not be covered. The overall ecosystem to work with python will be also presented (anaconda, notebook) and also collaborative tools (google collab, mybinder, ...).
